...
Скачивай видео с YouTube (и других источников, поддерживаемых yt-dlp) и получай к нему транскрипты и краткое содержание — в том числе **на русском**, даже если у видео нет готовых транскриптов. Всё работает **локально**: транскрипция через faster-whisper,
